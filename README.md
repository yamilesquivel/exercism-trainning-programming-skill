...
Our current objective is to make Exercism scalable.
...
Update: We have called this the Track Anatomy Project. In our prototype Track (Ruby), the result of the Track Anatomy Project saw an average reduction in waiting time from one week to half a day and reduced the queue from hundreds to ~30 at any time. It also saw a doubling in the number of submissions per week and dramatically increased mentor retention, with the most active weekly number mentors of any track. Encoding this into a framework and applying it to all tracks should have a dramatic positive effect on mentor enjoyment.
2. Automatically analyze common solution
...
Update: We have called this the Mentor-Learner Relationship Project.
